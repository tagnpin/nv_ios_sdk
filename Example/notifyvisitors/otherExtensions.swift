...
enum nvButtonActionType: Int {
    case  showInAppBannerOrSurvey,
          launchNotificationCenter,
          getUnreadPushCount,
          trackEvent,
          trackUserIdentifier,
          getNV_UID,
...
static var topViewController:UIViewController? {
    get{
if var topController = UIApplication.shared.mainKeyWindow?.rootViewController {
...
return nil
    ...
    static func printedPrityJSON(inputData: [AnyHashable : Any]) -> String {
    let data = try? JSONSerialization.data(withJSONObject: inputData as [AnyHashable : Any], options: .prettyPrinted)
...
//        let mobileRegExPred = NSPredicate(format:"SELF MATCHES %@", mobileRegEx)
//        return mobileRegExPred.evaluate(with: mobileNo)
//        }
//
//
...
//        if let jsonDataToVerify = jsonStr.data(using: String.Encoding.utf8) {
//            do {
